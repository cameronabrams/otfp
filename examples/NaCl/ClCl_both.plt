...
IF1='ClCl.namd';IF2='ClCl.LAMBDA';eval INTERM('ClCl_both.tex','(8.5*2)cm,7.5cm')
...
plot [rmin:rmax][-0.5:3.5] 0 lc rgb 'black' t '',\
...
plot [][-0.5:3.5] IF2 u (column(knots/2)) w l ls 1 lw 3 lc @ZUB5_1 t ''
